...
st.title('Analyze and compare continuous PDD')
...
if file_bp:
    ...
    ext_file = st.file_uploader("Choose another PDD to compare", key='ext_bp')
    ...
    if ext_file and smoothfactor != 0:
        ...
        #
        # # create the data frame
        # df_ext_2 = pd.read_csv(ext_file, skiprows=0, sep='\t\t', engine='python')
        # df_ext_2['PDD'] = df_ext_2.Dose / df_ext_2.Dose.max() * 100
        #
        # fig1.add_scatter(
        #     x=df_ext_2['Z'],
        #     y=df_ext_2['PDD'],
        ...
        if show_gamma:
            ...
            positions_ref = (np.array(df_ext_2[' Depth']),)
